package trousers.extendedae2.parts.reporting;
...
public class ExtendedInterfaceTerminalPart extends AbstractDisplayPart {
    ...
    public ExtendedInterfaceTerminalPart(final ItemStack is) {
        super(is);
    }
    ...
    public boolean onPartActivate(final PlayerEntity player, final Hand hand, final Vector3d pos) {
        if (!super.onPartActivate(player, hand, pos)) {
            if (!isRemote()) {
                ContainerOpener.openContainer(ExtendedInterfaceTerminalContainer.TYPE, player, ContainerLocator.forPart(this));
            }
        }
        return true;
    }
