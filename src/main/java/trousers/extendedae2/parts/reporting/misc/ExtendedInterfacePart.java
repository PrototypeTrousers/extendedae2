package trousers.extendedae2.parts.reporting.misc;
...
public class ExtendedInterfacePart extends InterfacePart {
    ...
    public ExtendedInterfacePart(final ItemStack is) {
        super(is);
    }
