...
public class ExtendedInterfaceTerminalScreen extends AEBaseScreen<ExtendedInterfaceTerminalContainer> {
    ...
    public ExtendedInterfaceTerminalScreen(ExtendedInterfaceTerminalContainer container, PlayerInventory playerInventory,
