...
@Mod("extendedae2")
public class ExtendedAE2 implements IAEAddon {
    public static final Logger LOGGER = LogManager.getLogger();
    public static final String MODID = "extendedae2";
    // Directly reference a log4j logger.
    public static IAppEngApi AE2APIINSTANCE;
    ...
    private void doClientStuff(final FMLClientSetupEvent event) {
        ...
        DistExecutor.unsafeRunWhenOn(Dist.CLIENT, () -> ModScreens::registerScreenTypes);
    }
